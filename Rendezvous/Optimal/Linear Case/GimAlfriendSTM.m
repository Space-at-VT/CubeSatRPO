classdef GimAlfriendSTM < handle
    ...
    properties
        ...
        deputyOrbitDescriptionInit  % Descriptor flag for deputy's initial orbit
        deputyOrbitDescriptionFinal % Descriptor flag for deputy's final orbit
        ...
        DepElemsInit            % Initial Kepler Elements of deputy
        DepElemsInitNS          % Initial Nonsingular Elements of deputy
        DepOsc                  % Deputy Osculating Elements
    ...
    methods
        % Initialization of GimAlfriendSTM Class
        function obj = GimAlfriendSTM(initStruct)
            ...
            % Convert states to Osculating Elements
            ...
            % Convert initial conditions into curvilinear initial state
            ...
            % Convert terminal conditions into final curvilinear state
        ...
        % Discretize the continuous-time model for use in LP
