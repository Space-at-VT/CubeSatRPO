function plotSimulationsV2(Time,X,Ref,Xt0,Xf,Uk,err,Thruster,Umax,yaw,pitch,...
    roll,Torques,maxTorque,mOpt,mTrack,deltaVOptimal,deltaVTracking,appends)
...
axis tight
% %saveas(fig1,['mimpcfigures/1norm3d_tf_' num2str(Time(end)) '' appends '.fig'])
...
set(leg1,'interpreter','latex','fontsize',8);
axis tight
% %saveas(fig2,['mimpcfigures/2norm3d_tf_' num2str(Time(end)) '' appends '.fig'])
...
set(leg1,'interpreter','latex','fontsize',12);
axis tight
%saveas(fig4,['mimpcfigures/2normerr_tf_' num2str(Time(end)) '' appends '.fig'])
...
set(leg1,'interpreter','latex','fontsize',12);
axis tight
% %saveas(fig5,['mimpcfigures/1normerrv_tf_' num2str(Time(end)) '' appends '.fig'])
...
set(leg1,'interpreter','latex','fontsize',12);
axis tight
% %saveas(fig6,['mimpcfigures/2normerrv_tf_' num2str(Time(end)) '' appends '.fig'])
...
set([title1 yl1 yl2 yl3 xl],'interpreter','latex','fontsize',12)
set(leg1,'interpreter','latex','fontsize',8);
%saveas(fig7,['mimpcfigures/1normthruster_tf_' num2str(Time(end)) '' appends '.fig'])
...
set([title1 yl1 yl2 yl3 xl],'interpreter','latex','fontsize',12)
set(leg1,'interpreter','latex','fontsize',8);
%saveas(fig8,['mimpcfigures/2normthruster_tf_' num2str(Time(end)) '' appends '.fig'])
...
set(leg1,'interpreter','latex','fontsize',8);
axis tight
%saveas(fig9,['mimpcfigures/1normeuler_tf_' num2str(Time(end)) '' appends '.fig'])
...
set(leg1,'interpreter','latex','fontsize',8);
axis tight
%saveas(fig10,['mimpcfigures/2normeuler_tf_' num2str(Time(end)) '' appends '.fig'])
...
set([title1 yl1 yl2 yl3 xl],'interpreter','latex','fontsize',12)
set(leg1,'interpreter','latex','fontsize',8)
%saveas(fig11,['mimpcfigures/1normtorques_tf_' num2str(Time(end)) '' appends '.fig'])
...
set([title1 yl1 yl2 yl3 xl],'interpreter','latex','fontsize',12)
set(leg1,'interpreter','latex','fontsize',8)
%saveas(fig12,['mimpcfigures/2normtorques_tf_' num2str(Time(end)) '' appends '.fig'])
...
%saveas(fig13,['mimpcfigures/1normmass_tf_' num2str(Time(end)) '' appends '.fig'])
...
yl = ylabel('Mass, $m$, kg');
set([leg1 title1 xl yl],'interpreter','latex','fontsize',10)
%saveas(fig14,['mimpcfigures/2normmass_tf_' num2str(Time(end)) '' appends '.fig'])
